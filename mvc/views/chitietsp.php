...
<head>
    ...
    <link rel="stylesheet" href="/nienluanCNTT/public/css/gioithieu.css" />
    <?php 
        if (isset($data["css"])) {
                            ...
                            <div class="slider-content-gt">
                                ...
                                <ul class="ul-banner">
                                    <li style="list-style: none">
                                        <a class="item-banner-a" href="/nienluanCNTT/home">Trang Chủ</a>
                                    </li>
    ...
    <footer>
        ...
        <div class="bg-footer">
            <div class="container">
                ...
                <div class="row py-4">
                    <div class="col-3">
                        <img class="logo-footer" src="./public/img/logo.png" alt="" />
...
const $carousel = $(".carousel-ctsp").flickity();
$(".ctsp-btn__prev").on("click", function() {
    $carousel.flickity("previous", true);
});

$(".ctsp-btn__next").on("click", function() {
