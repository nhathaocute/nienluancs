                ...
                <div class="row py-4">
                    <div class="col-3">
                        ...
                        <div class="footer_group">
                            <p class="footer_box">
                                <i class="fa-sharp fa-solid fa-location-dot"></i>Trường Đại học Cần thơ, ấp Hòa Đức, xã
                            ...
                            <p class="footer_box">
                                ...
                                <a href="mailto:haob2014831@student.ctu.edu.vn"
                                    target="_blank">haob2014831@student.ctu.edu.vn</a>
                            </p>
                        </div>
                    </div>
                    <div class="col-3">
...
function goToLocation(city) {
    switch (city) {
        case 'Hà Nội':
            window.location.href = '/nienluanCNTT/Home/search?tinh=Hà+Nội';
            break;
        case 'Đà Nẵng':
            window.location.href = '/nienluanCNTT/Home/search?tinh=Đà+Nẵng';
            break;
        case 'Nghệ An':
            window.location.href = '/nienluanCNTT/Home/search?tinh=Nghệ+An';
            break;
        case 'Hải Phòng':
            window.location.href = '/nienluanCNTT/Home/search?tinh=Hải+Phòng';
            break;
        case 'TP.HCM':
            window.location.href = '/nienluanCNTT/Home/search?tinh=TP+HCM';
            break;
        default:
            break;
    }
...
<?php 
        if (isset($data["js"])) {
            echo "<script src='/nienluanCNTT/public/js/". $data["js"] .".js'></script>";
